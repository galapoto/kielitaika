...
class YKIOrchestrator:
    ...
    async def submit_recording(self, session_id: str, payload: dict):
        ...
        await self.engine.submit_audio(
    ...
    def _extract_engine_session_id(self, engine_data: dict) -> str:
        for key in ("engine_session_token", "session_id", "sessionId", "id"):
    ...
    def _normalize_tasks(self, section: str, tasks: list[dict[str, Any]]) -> list[dict[str, Any]]:
        normalized = []
