...
export function ScreenScaffold(props: PropsWithChildren<{ className?: string; header?: ReactNode; actions?: ReactNode; centerContent?: boolean }>) {
  return (
    <div className={`screen-shell ${props.centerContent ? "center-content" : ""} ${props.className || ""}`.trim()}>
      ...
      <div className="screen-content-zone">{props.children}</div>
